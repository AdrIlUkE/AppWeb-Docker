<?php
/** 
 * Template Name: Plantilla de la noticia
...
<?php get_header()?>
    ...
    <section class="d-flex flex-column vh-100 container-fluid">
        <div class="row mt-5 mx-5 text-center">
            <div class="col-sm-12">
                <img class="img" src="wp-content/themes/adca/assets/image 2 (2).jpg" alt="">
            </div>
        </div>
        <div class="row mt-5 mx-5 text-center">
            <h1 class="inter-bold mb-5 mt-5 display-6">Finibus Bonorum et Malorum</h1>
            <p class="inter-regular p-5"><strong> by John doe</strong> Monday May 20</p>
        </div>
        <div class="row mt-5 mx-5 text-start">
            <p class="inter-regular">Section 1.10.32 of "de Finibus Bonorum et Malorum", written by Cicero in 45
                BC<br>"Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium,
        ...
        <div class="row mt-5 mx-5 text-start">
            <p class="inter-regular">1914 translation by H. Rackham<br>"But I must explain to you how all this mistaken
                ...
                painful. Nor again is there anyone who loves or pursues or desires to obtain pain of itself, because it
                is pain, but because occasionally circumstances occur in which toil and pain can procure him some great
        ...
        <div class="row mt-5 mx-5 text-start">
            <p class="inter-bold">1.10.33 of "de Finibus Bonorum et Malorum"</p>
        </div>
        <div class="row mt-5 mx-5 text-start">
        ...
        <div class="row mt-5 mx-5 text-start">
            <h1 class="inter-bold">Section</h1>
        </div>
        <div class="row mt-5 mx-5 text-start">
            <p class="inter-regular">"At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
        ...
        <div class="row mt-5 mx-5 text-start">
            <h1 class="inter-bold">Section 1.10.33</h1>
        </div>
        <div class="row mt-5 mx-5 text-start">
            <div class="col-sm-11">
                <p>"At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum
                    ...
                    maiores alias consequatur aut perferendis doloribus asperiores repellat."<br>Section 1.10.33 of "de
                    Finibus Bonorum et Malorum", written by Cicero in 45 BC<br>"At vero eos et accusamus et iusto odio
